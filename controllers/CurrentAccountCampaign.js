...
class currentAccountCampaign {
  ...
  static async getDateAccount(req, res) {
      ...
      if(month != null && month != ' ' && month != '') {
        ...
        console.log(getConnectionObj)
          ...
          for (let i in reportData) {
            ...
            const url = "http://192.168.2.151:3004/api/controllers/modules/reports/reportscontroller/get_customized_report_data"
          ...
          res.status(400).json("not information")
        }
      }else{
        res.status(400).json("notfound Information Body")
      }
